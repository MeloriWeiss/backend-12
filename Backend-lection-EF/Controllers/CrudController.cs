...
//     public CrudController(AppDbContext dbContext, ILogger<CrudController> logger)
//     {
...
//             var entity = new Entity() {Name = request.Name, Surname = request.Surname};
//             _dbContext.Entities.Add(entity);
//             _dbContext.SaveChanges();
//             
//             _logger.LogInformation("New entity created");
//             
...
//             _logger.LogError(e, "[AddEntity] server error");
...
//         {
//             // в случае ошибки возвращаем статус-код 400 с сообщением "Ошибка"
//             _logger.LogError(e, "[GetEntities] server error");
//             return BadRequest("Ошибка");
//         }
//     }
//     
...
//         {
//             // в случае ошибки возвращаем статус-код 400 с сообщением "Ошибка"
//             _logger.LogError(e, "[GetEntity] server error");
//             return BadRequest("Ошибка");
//         }
//     }
//     
...
//         {
//             // в случае ошибки возвращаем статус-код 400 с сообщением "Ошибка"
//             _logger.LogError(e, "[UpdateEntity] server error");
//             return BadRequest("Ошибка");
//         }
//     }
//     
